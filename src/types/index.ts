...
export interface AboutTranslations {
  ...
  ticketAdult: string;
  ticketAdultPrice: string;
  ticketChild: string;
  ticketChildPrice: string;
  ticketGroup: string;
  ticketGroupPrice: string;
  ticketVip: string;
  ticketVipPrice: string;
  ticketFeature1: string;
  ticketFeature2: string;
  ticketFeature3: string;
  ticketFeatureVip1: string;
  ticketFeatureVip2: string;
  ticketFeatureVip3: string;
